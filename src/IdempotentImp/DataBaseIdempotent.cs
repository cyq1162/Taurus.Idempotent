...
{
    internal partial class DataBaseIdempotent : Idempotent
    {
        string tableName;
        string conn;
        public DataBaseIdempotent(string tableName, string conn)
        {
        ...
        public override IdempotentType IdempotentType
        {
            get
            {
                return IdempotentType.DataBase;
            }
        }
    }
    internal partial class DataBaseIdempotent
    {
        private bool AddAll(string key, string value, double cacheMinutes)
        {
